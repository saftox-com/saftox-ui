...
const CustomSlotsTemplate = (args: AvatarGroupProps) => (
  <AvatarGroup {...args}>
    <Avatar
      classes={{ base: 'border-2 border-yellow-400' }}
      radius="sm"
      size="sm"
      src="https://i.pravatar.cc/150?u=a042581f4e29026024d"
    />
    <Avatar
      classes={{ base: 'border-2 border-yellow-500' }}
      radius="sm"
      size="sm"
      src="https://i.pravatar.cc/150?u=a04258a2462d826712d"
    />
    <Avatar
      classes={{ base: 'border-2 border-yellow-600' }}
      radius="sm"
      size="sm"
      src="https://i.pravatar.cc/150?u=a042581f4e29026704d"
    />
    <Avatar
      classes={{ base: 'border-2 border-yellow-700' }}
      radius="sm"
      size="sm"
...
export const CustomCount = {
  ...
  args: {
    ...
    max: 3,
    total: 10,
    renderCount: (count: number) => <p class="text-sm text-black dark:text-white ms-2">+{count}</p>,
  },
}
...
export const CustomSlots = {
  ...
  args: {
    classes: { count: 'border-2 border-yellow-400' },
    max: 3,
    radius: 'sm',
    size: 'sm',
  },
