 ...
 *
 * ```js
 * import { inline } from '@saftox-ui/twind'
 *
 * function render() {
 ...
 *
 * ```js
 * import { extract } from '@saftox-ui/twind'
 *
 * function render() {
 *   const { html, css } = extract(renderApp())
 *
 *   // inject as last element into the head
 *   return html.replace('</head>', `<style data-stafna>${css}</style></head>`)
 * }
 * ```
 *
 * You can provide your own Twind instance:
 ...
 *
 * ```js
 * import { consume, stringify, tw } from '@saftox-ui/twind'
 *
 * function render() {
 ...
 *
 *   // inject as last element into the head
 *   return markup.replace('</head>', `<style data-stafna>${css}</style></head>`)
 * }
 * ```
 *
 * You can provide your own Twind instance:
 *
 * ```js
 * import { consume, stringify } from '@saftox-ui/twind'
 * import { tw } from './custom/twind/instance'
 *
 * function render() {
 *   const html = renderApp()
