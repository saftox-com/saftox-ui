import type { BaseTheme, CSSProperties, MaybeArray } from "@saftox-ui/twind";

declare module "@saftox-ui/twind" {
...
export type FontFamilyValue =
	...
	| [
			...
			configuration: { fontFeatureSettings?: string },
	  ];
...
export type SaftoxTheme = BaseTheme & {
