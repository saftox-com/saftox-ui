import type { Preflight } from "@saftox-ui/twind";
...
const preflight: Preflight = {
	...
	html: {
		...
		fontFamily: `theme(fontFamily.sans, ${
			(theme.fontFamily as Record<string, string>).sans
		})` /* 4 */,
		fontFeatureSettings:
			"theme(fontFamily.sans[1].fontFeatureSettings, normal)" /* 5 */,
		colorScheme: "light",
	},
	...
	"code,kbd,samp,pre": {
		fontFamily: `theme(fontFamily.mono, ${
			(theme.fontFamily as Record<string, string>).mono
		})`,
		fontFeatureSettings:
