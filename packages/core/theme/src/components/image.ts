 ...
 * @example
 * <div classes={wrapper()}>
 *    <img alt="image" classes={img())} src="https://..." />
 *      // wrap the image if you want to zoom it
 *      <div classes={zoomedWrapper()}>
 *       <img alt="image" classes={img())} src="https://..." />
 *     </div>
 *    // duplicate it for the blur effect
 *    <img alt="image" classes={blurredImg())} src="https://..." />
 * </div>
 */
const image = tv({
  slots: {
    ...
    showSkeleton: {
      true: {
        wrapper: [
          ...
          'relative',
          'overflow-hidden',
          'bg-content3 dark:bg-content2-foreground',
        ],
        img: 'opacity-0',
      },
    },
  ...
  compoundVariants: [
    {
      ...
      class: {
        wrapper: [
          ...
          'after:-z-10',
          'after:bg-content3',
          'dark:after:bg-content2-foreground',
        ],
      },
    },
  ],
