...
/**
 * Snippet wrapper **Variants** component
 *
...
const snippet = tv({
	slots: {
		...
		copyIcon: [
			"w-5 h-5 absolute text-inherit opacity-100 scale-100 group-data-[copied=true]:opacity-0 group-data-[copied=true]:scale-50",
		],
		checkIcon: [
			"w-5 h-5 absolute text-inherit opacity-0 scale-50 group-data-[copied=true]:opacity-100 group-data-[copied=true]:scale-100",
		],
	},
	variants: {
		variant: {
