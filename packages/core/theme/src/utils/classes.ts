...
export const collapseAdjacentVariantBorders = {
  default: '[&+.border-medium.border-default]:ms-[calc(theme(borderWidth.1)*-1)]',
  primary: ['[&+.border-medium.border-primary]:ms-[calc(theme(borderWidth.1)*-1)]'],
  secondary: ['[&+.border-medium.border-secondary]:ms-[calc(theme(borderWidth.1)*-1)]'],
  success: ['[&+.border-medium.border-success]:ms-[calc(theme(borderWidth.1)*-1)]'],
  warning: ['[&+.border-medium.border-warning]:ms-[calc(theme(borderWidth.1)*-1)]'],
  danger: ['[&+.border-medium.border-danger]:ms-[calc(theme(borderWidth.1)*-1)]'],
}
