...
export const PressResponderContext =
	createContext<PressResponderContextValue>();
...
function usePressResponderContext<T extends HTMLElement>(
	...
	const combinePropsResult = combineProps(contextProps, props);
...
export function createPress<T extends HTMLElement>(
	...
	const [ignoreEmulatedMouseEvents, setIgnoreEmulatedMouseEvents] =
		createSignal(false);
	...
	if (typeof PointerEvent !== "undefined") {
		...
		pressProps.onMouseDown = (e) => {
			...
			const newPointerType = setPointerType(
				isVirtualClick(e) ? "virtual" : "mouse",
			);
