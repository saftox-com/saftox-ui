...
export const Sun: Component<IconProps> = (_props) => {
  const [props, otherProps] = splitProps(_props, ['fill', 'filled', 'size', 'height', 'width'])
...
export const Mail: Component<IconProps> = (_props) => {
  const [props, otherProps] = splitProps(_props, ['fill', 'size', 'height', 'width'])
...
export const Moon: Component<IconProps> = (_props) => {
  const [props, otherProps] = splitProps(_props, ['fill', 'filled', 'size', 'height', 'width'])
...
export const Lock: Component<IconProps> = (_props) => {
  const [props, otherProps] = splitProps(_props, ['fill', 'size', 'height', 'width'])
...
export const Unlock: Component<IconProps> = (_props) => {
  const [props, otherProps] = splitProps(_props, ['fill', 'size', 'height', 'width'])
  const color = props.fill
...
export const Password: Component<IconProps> = (_props) => {
  const [props, otherProps] = splitProps(_props, ['fill', 'size', 'height', 'width'])
...
export const Notification: Component<IconProps> = (_props) => {
  const [props, otherProps] = splitProps(_props, ['fill', 'size', 'height', 'width'])
...
export const User: Component<IconProps> = (_props) => {
  const [props, otherProps] = splitProps(_props, ['fill', 'size', 'height', 'width'])
...
export const VolumeUp: Component<IconProps> = (_props) => {
  const [props, otherProps] = splitProps(_props, ['fill', 'size', 'height', 'width'])
...
export const Camera: Component<IconProps> = (_props) => {
  const [props, otherProps] = splitProps(_props, ['fill', 'size', 'height', 'width'])
...
export const Activity: Component<IconProps> = (_props) => {
  const [props, otherProps] = splitProps(_props, ['fill', 'size', 'height', 'width'])
...
export const Plus: Component<IconProps> = (_props) => {
  const [props, otherProps] = splitProps(_props, ['fill', 'size', 'height', 'width'])
...
export const Minus: Component<IconProps> = (_props) => {
  const [props, otherProps] = splitProps(_props, ['fill', 'size', 'height', 'width'])
...
export const Eye: Component<IconProps> = (_props) => {
  const [props, otherProps] = splitProps(_props, ['fill', 'size', 'height', 'width'])
...
export const Edit: Component<IconProps> = (_props) => {
  const [props, otherProps] = splitProps(_props, ['fill', 'size', 'height', 'width'])
...
export const Delete: Component<IconProps> = (_props) => {
  const [props, otherProps] = splitProps(_props, ['fill', 'size', 'height', 'width'])
...
export const ChevronDown: Component<IconProps> = (_props) => {
  const [props, otherProps] = splitProps(_props, ['fill', 'size', 'height', 'width'])
...
export const ChevronDownBold: Component<IconProps> = (_props) => {
  const [props, otherProps] = splitProps(_props, ['fill', 'size', 'height', 'width'])
...
export const NewFile: Component<IconProps> = (_props) => {
  const [props, otherProps] = splitProps(_props, ['fill', 'size', 'height', 'width'])
...
export const AddNoteBulk: Component<IconProps> = (_props) => {
  const [props, otherProps] = splitProps(_props, ['fill', 'size', 'height', 'width'])
...
export const CopyDocumentBulk: Component<IconProps> = (_props) => {
  const [props, otherProps] = splitProps(_props, ['fill', 'size', 'height', 'width'])
...
export const EditDocumentBulk: Component<IconProps> = (_props) => {
  const [props, otherProps] = splitProps(_props, ['fill', 'size', 'height', 'width'])
...
export const DeleteDocumentBulk: Component<IconProps> = (_props) => {
  const [props, otherProps] = splitProps(_props, ['fill', 'size', 'height', 'width'])
...
export const CartIcon: Component<IconProps> = (_props) => {
  const [props, otherProps] = splitProps(mergeProps({ fill: 'currentColor' }, _props), [
    'fill',
    'size',
    'height',
    'width',
...
export const Flash: Component<IconProps> = (_props) => {
  const [props, otherProps] = splitProps(mergeProps({ fill: 'currentColor' }, _props), [
    'fill',
    'size',
    'height',
...
export const Server: Component<IconProps> = (_props) => {
  const [props, otherProps] = splitProps(mergeProps({ fill: 'currentColor' }, _props), [
    'fill',
    'size',
    'height',
...
export const TagUser: Component<IconProps> = (_props) => {
  const [props, otherProps] = splitProps(mergeProps({ fill: 'currentColor' }, _props), [
    'fill',
    'size',
    'height',
...
export const Scale: Component<IconProps> = (_props) => {
  const [props, otherProps] = splitProps(mergeProps({ fill: 'currentColor' }, _props), [
    'fill',
    'size',
    'height',
...
export const Search: Component<IconProps> = (_props) => {
  const [props, otherProps] = splitProps(mergeProps({ width: 24, height: 24 }, _props), [
    'size',
    'fill',
    'width',
    'height',
