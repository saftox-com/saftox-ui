...
export const Dynamic = <ElementProps,>(props: DynamicAttributes<ValidComponent> & ElementProps) => {
  const [localProps, otherProps] = splitProps(props, ['as'])

  const cached = createMemo<Function | string>(() => localProps.as ?? DEFAULT_DYNAMIC_ELEMENT)
