...
import type { ChipSlots, ChipVariantProps, SlotsToClasses } from '@saftox-ui/theme'
...
export type ContentValidComponent = JSX.Element | VoidComponent<ContentPropsFn | ContentProps>
...
export type GetContentCloneProps = (content: ValidComponent | ContentValidComponent) => JSX.Element

export type GetAvatarCloneProps = (avatar: JSX.Element | VoidComponent<AvatarProps>) => JSX.Element
